...
import 'package:provider/provider.dart'; // 👈 1. Added Provider import to reach your AuthService
import 'auth_service.dart';             // 👈 2. Added AuthService import to trigger log out
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              ...
              // 🔴 Connected Secure Session Log Out Button
              OutlinedButton(
                ...
                onPressed: () async {
                  // 🔌 Handshake with backend to sign out user
                  await Provider.of<AuthService>(context, listen: false).signOut();
                }, // ✅ Stray letter 'f' removed from here!
                child: const Text(
